...
- **CRITICAL ACTION**: You MUST execute `view_file .agents/rules/security-guardrails)-guardrails.md` NOW. Check for **CRITICAL Security** violations (Block commit immediately):
