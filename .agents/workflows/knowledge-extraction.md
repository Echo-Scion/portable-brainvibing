...
This means the knowledge.md) graph (`orion.db`) requires true semantic relationships (triplets) to be mapped for the newly ingested files, replacing the deprecated AST method.
