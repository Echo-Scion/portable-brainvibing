...
## 1. Purpose
Metrics provide quantitative data to the integrity-sentinel skill (via `view_file .agents/skills/integrity-sentinel/SKILL.md`), allowing for data-driven refinements.
