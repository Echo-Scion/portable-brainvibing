...
`caveman-compress` is flagged as Snyk High Risk due to subprocess and file I/O patterns detected by static analysis. This is a false positive — see [[SECURITY]])) for a full explanation of what the skill does and does not do.
