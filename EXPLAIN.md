...
# (Portable Brainvibing Infrastructure v0.0.11)
...
3. **Graph Triplets (Cloud Extraction)**: Uses AST/Regex for shallow graph extraction, and delegates Deep Extraction (Subject-Predicate-Object logic) to Cloud LLMs during ingestion.
